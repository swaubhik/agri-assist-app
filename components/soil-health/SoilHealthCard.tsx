...
export default function SoilHealthCard({
  ...
  const calculateOverallScore = () => {
    const nScore = ((reading.nitrogen ?? 0) / 100) * 33;
    const pScore = ((reading.phosphorus ?? 0) / 100) * 33;
    const kScore = ((reading.potassium ?? 0) / 100) * 33;
  ...
  const nitrogenRating = getNitrogenRating(reading.nitrogen ?? 0);
  const phosphorusRating = getPhosphorusRating(reading.phosphorus ?? 0);
  const potassiumRating = getPotassiumRating(reading.potassium ?? 0);
    ...
    <Card style={styles.card}>
      ...
      <View style={styles.scoreContainer}>
        ...
        <View style={styles.scoreDetails}>
          ...
          <Text style={styles.scoreDescription}>{t('scoreDescription')}</Text>
        </View>
      </View>
      ...
      <View style={styles.nutrientsContainer}>
        ...
        <View style={styles.nutrientRow}>
          ...
          <View style={styles.nutrientValue}>
            <View
              style={[
                styles.valueBar,
                {
                  width: `${Math.min(100, reading.nitrogen ?? 0)}%`,
          ...
          <Text
            style={[styles.nutrientStatus, { color: nitrogenRating.color }]}
          >
            {nitrogenRating.text}
          </Text>
        </View>
        ...
        <View style={styles.nutrientRow}>
          ...
          <View style={styles.nutrientValue}>
            <View
              style={[
                styles.valueBar,
                {
                  width: `${Math.min(100, reading.phosphorus ?? 0)}%`,
          ...
          <Text
            style={[styles.nutrientStatus, { color: phosphorusRating.color }]}
          >
        ...
        <View style={styles.nutrientRow}>
          ...
          <View style={styles.nutrientValue}>
            <View
              style={[
                styles.valueBar,
                {
                  width: `${Math.min(100, reading.potassium ?? 0)}%`,
          ...
          <Text
            style={[styles.nutrientStatus, { color: potassiumRating.color }]}
          >
      ...
      <View style={styles.recommendationsContainer}>
        ...
        <View style={styles.recommendationItem}>
          ...
          <Text style={styles.recommendationText}>
            {nitrogenRating.text === t('low')
              ? t('applyNitrogenFertilizer')
              : phosphorusRating.text === t('low')
              ? t('applyPhosphorusFertilizer')
              : potassiumRating.text === t('low')
              ? t('applyPotassiumFertilizer')
        ...
        <View style={styles.recommendationItem}>
          ...
          <Text style={styles.recommendationText}>
            {overallRating.text === t('excellent')
              ? t('excellentCropSuggestion')
              : overallRating.text === t('moderate')
              ? t('moderateCropSuggestion')
